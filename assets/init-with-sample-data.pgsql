...
COPY public."Deposit" (id, title_el, title_en, content, abstract_el, abstract_en, keywords_el, keywords_en, pages, language, images, tables, diagrams, maps, drawings, confirmed, confirmed_timestamp, license, comments, submitter_id, submitter_department, submitter_title, supervisor, new_filename, original_filename, date_created, date_uploaded) FROM stdin;
...
3	mitsi@hua.gr	mitsi	ΛΟΡΕΤΑ	ΜΗΤΣΗ	\N	\N	\N	\N	\N	\N	Γραμματεία Τμήματος Πληροφορικής και Τηλεματικής	Διοικητική Υπάλληλος	\N	f	t	f	2023-02-04 09:33:46.006	2022-12-24 17:37:58.608
